...
def run_watchdog_ui(config) -> int:
    ...
    fields = [
        ...
        ("UI PID", "ui_pid"),
        ("Poll", "poll"), ("Service window remaining", "service_window_remaining_seconds"), ("Next Gmail check in", "countdown_seconds"),
        ...
        ("Last duration", "poll_duration_seconds"), ("Poll owner", "poll_owner_pid"), ("Last error", "last_error"),
    ...
    def refresh() -> None:
        ...
        if not watchdog:
            ...
            max_polls = watchdog.get('max_polls') or 'window'
            values["poll"].configure(text=f"{watchdog.get('poll_number', 0)} / {max_polls}")
            for key in ("started_at", "ui_pid", "service_window_remaining_seconds", "countdown_seconds", "total_elapsed_seconds", "polling_for_seconds", "last_poll_at", "last_poll_action", "poll_duration_seconds", "poll_owner_pid", "last_error", "closing_countdown_seconds", "worker_pid", "worker_claim_elapsed_seconds", "codex_pid", "codex_start_elapsed_seconds", "finish_reason"):
