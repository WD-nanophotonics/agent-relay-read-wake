...
class RelayApp(tk.Tk):
    def __init__(self, supervisor: Supervisor):
        ...
        self.vars = {key: tk.StringVar(value="—") for key in ("state", "project", "project_id", "channel", "target", "repo", "chat", "run", "step", "lease", "poll", "matched", "staged", "wake", "error")}
        ...
        labels = (("Supervisor state", "state"), ("Project name", "project"), ("Project ID", "project_id"), ("Channel ID", "channel"), ("Codex target", "target"), ("Repository path", "repo"), ("ChatGPT target", "chat"), ("Current RUN", "run"), ("Expected STEP", "step"), ("Agent/lease state", "lease"), ("Last Gmail poll", "poll"), ("Last matched Gmail", "matched"), ("Last staged instruction", "staged"), ("Last wake", "wake"), ("Last error/fault", "error"))
